...
//---------- ES6 --------------
let startTimer = clearInterval => {(timer); //clears timer before timer starts. This fixes issue if timer is triggered again, when already running. 
...
//---------- ES6 --------------
let countMoves = clicks => {clicks = n}
    document.getElementById("clicks").firstChild.innerHTML = clicks;
...
//---------- ES6 --------------
let calculateScore =  timeScore => { parseInt.timeScore(timeScore + clicks);
    console.log(calculatedScore);
    document.querySelector("#score").firstChild.innerHTML = calculatedScore;
}
...
//---------- ES6 --------------
let generateRGBVal = generateRandomColor => {
    {
        let r = Math.random();
        r = r * 255;
        r = Math.round(r);
